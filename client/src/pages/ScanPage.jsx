...
const ScanPage = () => {
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      setPreviewLabel(`Ready to analyze: ${file.name}`)
    }
  }
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-white border border-[#1a3a2a]/8 rounded-2xl p-5 shadow-sm flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-gray-500">Position the affected leaf clearly within the frame markers.</p>
              </div>
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg border border-[#1a3a2a]/10 bg-slate-50 text-sm font-semibold text-[#1a3a2a] hover:bg-slate-100 transition-colors"
                >
                  <FiUpload size={16} />
                  Upload Image
                </button>
          ...
          <div className="space-y-4">
            <div className="bg-white border border-[#1a3a2a]/8 rounded-2xl p-5 shadow-sm flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Ensure the plant is well-lit in natural light for accurate detection.</p>
              </div>
            </div>
            ...
            <div className="bg-white border border-[#1a3a2a]/8 rounded-2xl p-5 shadow-sm flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Avoid blurry shots or multiple overlapping leaves in a single scan.</p>
              </div>
            </div>
          </div>
        </div>
